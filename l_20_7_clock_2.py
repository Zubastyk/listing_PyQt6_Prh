...
class MyWindow(QtWidgets.QWidget):
    ...
    def on_clicked_button1(self):
        #self.timer.start(100)   # Обновляет время на часах через 1 секунду
        QtCore.QTimer.singleShot(1000, self.on_timeout) # Показывает время нажатия кнопки 
